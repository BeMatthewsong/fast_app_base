...
final notificaitonDummies = <TtossNotification>[
  TtossNotification(
      NotificationType.tossPay,
      '이번 주에 저랑 영화 한 편 어때요? CGV 할인 쿠폰이 도착했어요.',
  ...
  TtossNotification(
    ...
    '유럽 식품 물가가 치솟고 있어요.\n송민혁님 유럽여행에 관심이 있다면 확인해보세요.',
    DateTime.now().subtract(8.hours),
    isRead: true,
  ),
  TtossNotification(NotificationType.walk, '1,000걸음 이상 걸었다면 포인트 받으세요.',
      DateTime.now().subtract(11.hours)),
  TtossNotification(NotificationType.luck, '4월 29일, 행운 복권이 도착했어요.',
